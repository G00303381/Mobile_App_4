...
public class AzureUILeaderboard : MonoBehaviour 
{
    ...
    [SerializeField]
	public string AzureEndPoint = "https://space-arena-mobile.azure-mobile.net/"; // Your Connection URL
	
	[SerializeField]
	public string ApplicationKey = "ooGQOOQYHisMvTEbimQeEsdXNeMhLZ35"; // Your API Key
